...
class User {
	...
	public function __construct($con, $user){
		$this->con = $con;
		$user_details_query = mysqli_query($con, "SELECT * FROM doctors WHERE doctorname='$user'");
		$this->user = mysqli_fetch_array($user_details_query);
	}

	public function getUsername() {
		return $this->user['doctorname'];
	}

	// public function getNumberOfFriendRequests() {
	// 	$username = $this->user['doctorname'];
	...
	// 	$username = $this->user['doctorname'];
	// 	$query = mysqli_query($this->con, "SELECT num_posts FROM users WHERE doctorname='$username'");
