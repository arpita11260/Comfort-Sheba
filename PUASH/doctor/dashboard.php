	...
	<head>
		...
		<style media="screen">
		 div#table_filter label::before{
				...
				.doctor-dash{
					background-image: url("doctor-dash.png");
				}
			...
			<div class="app-content">
				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						<!-- start: PAGE TITLE -->
						<section id="page-title" class="doctor-dash" style="border-bottom:2px solid black; background-color:#eaeaec;">
							<div class="row">
								<div class="col-sm-8">
                                        ...
                                        <div class="statistic-box">
											<p class="links cl-effect-1"></p>
												<h2><span class="count-number"></span></h2>
													...
													<a href="appointment-history.php">
														<h3 class="naame">Daily Appointments</h3>
													</a>
												<div class="sparkline1 text-center"></div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="statistic-box">
											<p class="links cl-effect-1"></p>
												<h2><span class="count-number"></span> </h2>
													...
													<a href="patient-prescription.php">
														<h3 class="naame">Create Prescription</h3>
													</a>
												<div class="sparkline1 text-center"></div>
                                        </div>
                                    </div>
                                ...
                                <a href="operation.php">
                                    <div class="panel-body">
                                        <div class="statistic-box">
											<p class="links cl-effect-1"></p>
												<h2><span class="count-number"></span></h2>
													<a class="btn-01" href="operation.php">
														<i class="fa fa-files-o"></i>
													</a>
													<a href="operation.php">
														<h3 class="naame">Operation Report</h3>
													</a>
												<div class="sparkline1 text-center"></div>
                                        </div>
                                    </div>
