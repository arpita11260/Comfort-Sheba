...
include('include/config.php');
    ...
    $md_name='N/A';
            ...
            $query12=mysqli_query($con,"select * from doctors where id='$author'");
            $row12=mysqli_fetch_array($query12);
            $_SESSION['author']=$row12['doctorname'];
            $author=$row12['doctorname'];
           
            $_SESSION['specialist']=$row12['specilization'];
            $_SESSION['address']=$row12['address'];
            $_SESSION['contact']=$row12['contactno'];
