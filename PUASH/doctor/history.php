            ...
            <div class="header-right-info pull-left clearfix">
                ...
                while($row=mysqli_fetch_array($query)){
                    ...
                    <h4 style="color: black">
                        <p><strong style="font-size: 25px">Patient Id : </strong><?php
                        echo $row['uniqueid'];
                        
                        ?> </p>
                        <strong style="font-size: 25px">Patient Name : </strong><?php
                        echo $row['fullname'];
                        
                        ?><p></p>
                        <p><strong style="font-size: 25px">Phone Number : </strong><?php
                        echo $row['phone'];
										...
										<div class="col-lg-12 col-md-12">
											...
											<div class="panel panel-white" style="padding:20px 20px;">
												<!-- <div class="panel-heading"> -->
													<h5 class="panel-title">My Appoinments to Patients</h5><br>
												<!-- </div> -->
