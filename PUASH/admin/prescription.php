			...
			<div class="app-content">
				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<!-- end: PAGE TITLE -->
						<!-- start: BASIC EXAMPLE -->
                        <form action="" name="prescription" id="prescription" role="form" method="post">
                                                 ...
                                                 <div class="form-group ">
                                                    ...
                                                    <div class="had">
                                                        ...
                                                        <div class="col-md-2 pid">
                                                            <input type="text" autocomplete="off" name="p_id" id="p_id" required=""  class="form-control" placeholder="Patient Id"> 
                                                        </div>

                                                        <div class="col-md-2">
                                                            <input type="text" autocomplete="off" class="form-control" placeholder="Patient Name" name="name" required="">
                                                        </div>

                                                        <input type="hidden" name="patient_id" required="">
                                                       
                                                        <div class="col-md-2">
                                                            <input type="text" autocomplete="off" class="form-control" placeholder="Phone Number" name="phone" required="">
                                                        </div>
