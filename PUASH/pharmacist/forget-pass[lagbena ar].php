	...
	if($count){
		...
		if($count2>0){
			$_SESSION['errmsg']="Your account is not activated.";
				...
				http://localhost/puash/PUASH/pharmacist/forMail/resetpass.php?token=$token";
	...
	<body class="login" style=" background-color:#e0e0d1;margin-top:2px;">
		<div class="row">
			<div class="main-login col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2 col-md-4 col-md-offset-4">
				...
				<h2 style=" color:white; 	padding: 15px; font-weight: 900;"><a href="../../index.html">PUASH <br></a> Pharmacist password</h2>
				</div>
