...
<html lang="en">
	<head>
		<title>Patient | Doctor List </title>
		<meta charset="utf-8" />
                        ...
                        $sql = " SELECT * FROM doctors";
                             while($row = mysqli_fetch_assoc($result)) {
                              ...
                              <tr>
                                ...
                                <td> '. $row["docEmail"].' </td>
                                <td><a href="book-appointment.php?id='.$row['id'].'"><i class="fa fa-calendar-plus-o" style="margin-left: 50px; color: darkblue; font-size:20px;"></i></a></td>
                              </tr>';}
              								echo $output;
                         ?>
                      </tbody>
