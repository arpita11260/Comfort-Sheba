...
if(isset($_POST['history'])){
    $history_post=$_POST['history'];
    $_SESSION['History']=$history_post;
    $_SESSION['uniqueid']=$_POST['uid'];

}

$GET_NAME=$_SESSION['History'];
...
$author=$row12['doctorname'];
$query1=mysqli_query($con,"select * from doctors where doctorname ='$author'");
$row1= mysqli_fetch_array($query1);
$_SESSION['specialist']=$row1['specilization'];
