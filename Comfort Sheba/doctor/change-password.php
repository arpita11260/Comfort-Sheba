...
$sql=mysqli_query($con,"SELECT password FROM  doctors where password='$cpass' && id='".$_SESSION['id']."'");
...
if($num>0)
  {
    if($npass != $cfpass){
 	...
 	mysqli_query($con,"UPDATE doctors set password='$npass', updationDate='$currentTime' where id='".$_SESSION['id']."'");
			...
			<div class="app-content">
				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						<!-- start: PAGE TITLE -->
						<section id="page-title" style="background-color: #673ab7; border-bottom: 2px solid black">
							<div class="row">
								<div class="col-sm-8">
...
<div class="form-group">
									...
									<input type="password" name="cfpass" class="form-control"  placeholder="Confirm Password">
														...
														<input type="submit" name="submit" class="btn btn-o btn-primary" id="sub-button">
