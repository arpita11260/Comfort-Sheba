...
include("check_valid.php");

if(isset($_POST['submit']))
{
  $otp=$_POST['otp'];
	$codeTable = mysqli_query($con,"SELECT * FROM patientcode WHERE ph_id='".$_SESSION['id']."' and pat_uid='$uniqueid'");
	...
	if($row>0){
      ...
      $value=1;
    	$up=mysqli_query($con,"UPDATE patientcode set value='$value' WHERE pat_uid= '$uniqueid' ");

		$_SESSION['errmsg']="success!";
  }
				else{$_SESSION['errmsg']="OTP is wrong!";}

			}

			else{$_SESSION['errmsg']="Not exist!";}
}
...
<?php include('sidebar.php');?>
			<div class="app-content">
                ...
                <div class="box-login" style="outline:#4CAF50 solid 2px;">
        				 Hi , this is the place of prescriptions
