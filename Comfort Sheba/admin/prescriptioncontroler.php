...
<link href="" rel="stylesheet">
    ...
    <div id="dif_p" class="container">
        <div class="row">
                     <a class="btn btn-primary" href="patient-prescription.php"><i class="fa fa-plus" aria-hidden="true"></i> Create (Trade) </a>
            
            <div class="social-icons pull-right">
            
            <a class="btn btn-primary" href="dashboard.php"><i class="fa fa-plus" aria-hidden="true"></i> PUASH </a>
            </div> 
        </div>
    </div>
